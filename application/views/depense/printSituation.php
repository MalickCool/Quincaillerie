<section role="main" class="content-body">
    ...
    <table style="width: 100%;" cellspacing="0">
        ...
        <tfoot>
            <tr>
                <td style="border: solid; border-color: #000; border-width: 0.5px; padding: 5px; text-align: left; font-weight: bold; font-size: 16px" colspan="4">Total Versement Banque</td>
                <td style="border: solid; border-color: #000; border-width: 0.5px; padding: 5px; text-align: right; font-weight: bold; font-size: 16px">
                    <?= $this->depense_m->formatNumber($total) ?> FCFA
                </td>
            </tr>
        </tfoot>
    </table>
